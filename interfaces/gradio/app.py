...
API_BASE = os.getenv("TB_HELP_API_BASE", "https://helpcentre-dsi-mdr.emergentai.ug")
...
with gr.Blocks() as demo:
    gr.Markdown("# TB HelpCentre")
    gr.Markdown("Ask questions about tuberculosis and get answers.")
